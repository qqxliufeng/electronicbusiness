 ...
 */
class TeamCutFragment : BaseNetWorkingFragment() {
    ...
    private fun loadData() {
        ...
        mPresent.getDataByPost(0x0, RequestParamsHelper.PRODUCT_MODEL, RequestParamsHelper.ACT_PRODUCT_TYPE, RequestParamsHelper.getProductTypeParams("2"))
    }
