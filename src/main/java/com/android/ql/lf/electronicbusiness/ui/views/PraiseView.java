...
public class PraiseView extends FrameLayout implements Checkable {
    ...
    public void setChecked(boolean checked) {
        ...
        if (isChecked) {
            tvPraiseCount.setTextColor(ContextCompat.getColor(getContext(), R.color.red_tv_color));
            ...
            tvPraiseCount.setTextColor(ContextCompat.getColor(getContext(), R.color.black_tv_color));
