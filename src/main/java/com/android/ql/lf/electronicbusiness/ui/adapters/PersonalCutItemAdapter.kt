 ...
 */
class PersonalCutItemAdapter(layoutId: Int, list: ArrayList<PersonalCutGoodsItemBean>) : BaseQuickAdapter<PersonalCutGoodsItemBean, BaseViewHolder>(layoutId, list) {
