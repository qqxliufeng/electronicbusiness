...
import com.android.ql.lf.electronicbusiness.utils.im.AudioRecoderUtils;
import com.android.ql.lf.electronicbusiness.utils.im.PopupWindowFactory;
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RxBus.getDefault().post(messageInfo);
                mEditText.setText("");
            }
        });
        return this;
